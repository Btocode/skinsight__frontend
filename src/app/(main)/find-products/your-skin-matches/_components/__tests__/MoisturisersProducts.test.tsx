...
describe('MoisturisersProducts', () => {
  ...
  it('slides left when left button is clicked', () => {
    ...
    const leftButton = screen.getByTestId('chevron-left-icon').closest('button');
    ...
    const scrollByCall = (HTMLElement.prototype.scrollBy as jest.Mock).mock.calls[0][0];
  ...
  it('slides right when right button is clicked', () => {
    ...
    const rightButton = screen.getByTestId('chevron-right-icon').closest('button');
  ...
  it('handles scroll events for infinite scrolling', () => {
    ...
    const slider = screen.getByTestId('chevron-right-icon').closest('button')?.previousSibling;
  ...
  it('applies correct styling to the container', () => {
    ...
    const sliderContainer = screen.getByTestId('chevron-right-icon').closest('button')?.previousSibling;
