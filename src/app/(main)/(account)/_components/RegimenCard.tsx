    ...
    <div className="w-full rounded-xl bg-white p-6 shadow-[0px_5.13px_33.34px_0px_#2C2C2C17] border border-[#EFEFEF]">
      <div className="flex flex-col lg:flex-row justify-between items-center gap-6">
        <div className="space-y-2">
          <h2 className="text-xl font-semibold text-accent">My Skincare</h2>
          <p className="text-sm text-accent">Saved on November 11, 2024</p>
          {/* Product Image */}
          <div className="flex items-center gap-2 mt-2 ">
            <div className="-ml-4 h-20 w-20 relative">
              <Image
            ...
            <div className="-ml-10 h-20 w-20 relative">
              <Image
        ...
        <div>
          <button className="flex items-center justify-center gap-2 rounded-full bg-violet-100 py-3 px-8 text-violet-600 transition-colors hover:bg-violet-200">
