...
const UserMenu = () => {
  ...
  const MenuButton = () => (
    <button
      ...
      className="flex justify-between items-center gap-2 border-2 px-4 border-[#EBEAED] rounded-[100px] min-w-[168px] h-[40px]"
    >
      <svg
        width="18"
        height="20"
  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      <div
        ...
        className={`absolute right-0 mt-2 w-[248px] h-[310px] origin-top-right transform rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5 transition-all duration-200 ease-in-out ${
          isOpen
